...
mm_model %>% 
  ...
  # model predictions
  geom_smooth(method = "loess", span = 1, se = FALSE, map = aes(y = n_cbh_pred), color = "black", size = 1.5) +
  geom_point(map = aes(y = n_cbh_pred), size = 5, shape = 23, color = "black", fill = "black") +
  # original data
  geom_point(map = aes(y = n_cbh_mean), size = 4, shape = 21, color = "black", fill = "gray") + 
  # organism panels
  facet_wrap(~organism, ncol=2) + 
